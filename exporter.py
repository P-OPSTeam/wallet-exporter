...
class AppMetrics:
    ...
    def __init__(self, polling_interval_seconds=60, walletconfig=False, logging=False):
        ...
        self.cosmos_registry = get_cosmos_registry("mainnet", self.rpc_call_status_counter)
        self.cosmos_testnet_registry = get_cosmos_registry("testnet", self.rpc_call_status_counter)
